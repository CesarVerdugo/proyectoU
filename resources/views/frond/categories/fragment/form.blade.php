<form id="formcategory" class="form-horizontal" method="POST" action="">
  ...
  <div class="row">
      <div class="col-sm-12">
          ...
          <input type="text" id="namecategory" required class="form-control"  name="namecategory" title="Nombre Categoria">
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="form-group">
          {!!link_to('#',$title='Registrar', $attributes =['id'=>'Registrocategory','class'=>'btn btn-success submit-btn btn-block','type'=>'submit'],$secure =null)!!}
