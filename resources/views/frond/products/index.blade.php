          ...
          <div class="card-body">
              ...
              <div class="container">
                  <ul class="nav nav-tabs" role="tablist" style="padding-left:70px">
                    ...
                    <li role="plantillas"><button href="#variables"  title="Crear producto" id="create-form-rol"  name="crear-form" type="button" class="btn btn-success btn-sm" aria-controls="variables" role="tab" data-toggle="tab"><i class="fas fa-plus-square" ></i></button></li>
              ...
              <div class="tab-content" >
                <div role="tabpanel" class="tab-pane fade in active" id="table" >
                      ...
                      <div class="card-body">
                         ...
                         {!! Form::model( ['route' => ['products.update', 'id'=>'idproductedit'], 'files' => true, 'method' => 'PUT']) !!}
