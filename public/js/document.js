...
$("#Registrocategory").on("click",function(e){
          e.preventDefault();
...
$('#Actualizarcategory').click(function(e){
  ...
  .then((willDelete) => {
    if (willDelete) {
      ...
      $.ajax({
        ...
        data: {_method: 'DELETE'},
        success:function(){
          $("#category").dataTable()._fnAjaxUpdate();
          swal("¡Su archivo  ha sido eliminado!", {
            icon: "success",
          });
...
//var file = $("#file"), //datos serializados
...
var token=$("#token").val();
  $.ajax({
    ...
    type:'POST',
    dataType:'json',
    data:{category_id:category_id,code:code,name:name,date:date,description:description,unit_price:unit_price,sale_price:sale_price,stockmin:stockmin,file:form_data},
    success:function(){
...
$("#Actualizarproduct").on("click",function(){

var category_id=$("#category_idedit").val();
...
var date= $("#dateproductedit").val();
var description = $("#descriptionproductedit").val();
var descuento=$("#descuentoedit").val();

var unit_price = $("#unit_priceedit").val();
var sale_price = $("#sale_priceedit").val();
var stockmin = $("#stockminedit").val();

var file = $("#fileedit").val(); //datos serializados
alert(file);
...
var token=$("#token").val();
  $.ajax({
    ...
    data:{descuento:descuento,category_id:category_id,code:code,name:name,date:date,description:description,unit_price:unit_price,sale_price:sale_price,stockmin:stockmin,file:file},
  ...
  $.ajax({
    ...
    success:function(){
        $('#commentaries').DataTable().ajax.reload();
          $('#commentariesPagePrincipal').DataTable().ajax.reload();
